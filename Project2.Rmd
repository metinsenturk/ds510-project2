...
##### Model Analysis
Another approach we used to to predict the presense of the heart disease is support vector machines (SVM). SVM divides the dataset into classes with the use of hyperplanes. Below, we found the best SVM with the tune function.
...
According to our analysis, we found the best cost and gamma values as 0.5 and 0.5, respectively. 
